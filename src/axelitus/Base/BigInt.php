...
class BigInt
{
    ...
    {
        if (!static::is($int1) || !static::is($int2)) {
            throw new \InvalidArgumentException("The \$int1 and \$int2 parameters must be int (or string representing a big int).");
        }
    ...
    public static function pow($base, $exponent)
    {
        if (!static::is($base) || !static::is($exponent)) {
            throw new \InvalidArgumentException("The \$base and \$exponent parameters must be int (or string representing a big int).");
        }
    ...
    public static function mod($base, $modulus)
    {
        if (!static::is($base) || !static::is($modulus)) {
            throw new \InvalidArgumentException("The \$base and \$modulus parameters must be int (or string representing a big int).");
        }
    ...
    {
        if (!static::is($base)) {
            throw new \InvalidArgumentException("The \$base parameters must be int (or string representing a big int).");
        }
