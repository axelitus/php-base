...
class ABigNum
{
    ...
    public static function toInt($value)
    {
        ...
        if (($decimal = AStr::pos($value, '.')) !== false) {
            $value = AStr::sub($value, 0, (int)$decimal);
        }
    ...
    public static function toFloat($value)
    {
        ...
        if (is_int($value) || is_float($value)) {
            ...
            return ((AStr::contains($value, '.')) ? $value : $value . '.0');
        }
    }
    ...
    public static function pow($base, $exponent, $scale = null)
    {
        ...
        if (ANum::is($base) && ANum::is($exponent)) {
    ...
    public static function mod($base, $modulus, $scale = null)
    {
        ...
        if (ANum::is($base) && ANum::is($modulus)) {
