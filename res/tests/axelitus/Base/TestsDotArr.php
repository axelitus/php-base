...
class TestsDotArr extends TestCase
{
    ...
    public function testIs()
    {
        ...
        $this->assertTrue(DotArr::is(['first' => 'a', 'second' => 'b', 'third' => 'c', 'fourth' => ['first' => 'd', 'second' => 'e']]));
        $this->assertFalse(DotArr::is(['first.dot' => 'a', 'second' => 'b', 'third' => 'c', 'fourth' => ['first' => 'd', 'second' => 'e']]));
        $this->assertFalse(DotArr::is(['first' => 'a', 'second.dot' => 'b', 'third' => 'c', 'fourth' => ['first' => 'd', 'second' => 'e']]));
        $this->assertFalse(DotArr::is(['first' => 'a', 'second' => 'b', 'third.dot' => 'c', 'fourth' => ['first' => 'd', 'second' => 'e']]));
        $this->assertFalse(DotArr::is(['first' => 'a', 'second' => 'b', 'third.dot' => 'c', 'fourth' => ['first' => 'd', 'second' => 'e']]));
        $this->assertFalse(DotArr::is(['first' => 'a', 'second' => 'b', 'third' => 'c', 'fourth.dot' => ['first' => 'd', 'second' => 'e']]));
        $this->assertFalse(DotArr::is(['first' => 'a', 'second' => 'b', 'third' => 'c', 'fourth' => ['first.dot' => 'd', 'second' => 'e']]));
        $this->assertFalse(DotArr::is(['first' => 'a', 'second' => 'b', 'third' => 'c', 'fourth' => ['first' => 'd', 'second.dot' => 'e']]));
    }
    ...
    public function testGet()
    {
        ...
        $this->assertEquals(['aaa' => 'A.AA.AAA'], DotArr::get(['a' => ['aa' => ['aaa' => 'A.AA.AAA']], 'b' => 'B', 'c' => 'C'], 'a.aa'));
        $this->assertEquals('A.AA.AAA', DotArr::get(['a' => ['aa' => ['aaa' => 'A.AA.AAA']], 'b' => 'B', 'c' => 'C'], 'a.aa.aaa'));
    ...
    public function testKeyMatches()
    {
        ...
        $this->assertEquals(['first', 'first.second', 'first.second.third'], DotArr::keyMatches($array, 'first.second.third'));
        $this->assertEquals(['first', 'first.second', 'first.second.third', 'first.second.third.fourth'], DotArr::keyMatches($array, 'first.second.third.fourth'));
        $this->assertEquals(['first', 'first.second', 'first.second.third', 'first.second.third.fourth', 'first.second.third.fourth.fifth'], DotArr::keyMatches($array, 'first.second.third.fourth.fifth'));
        $this->assertEquals(['first', 'first.second', 'first.second.third', 'first.second.third.fourth', 'first.second.third.fourth.fifth'], DotArr::keyMatches($array, 'first.second.third.fourth.fifth.sixth'));

        $array = ['first' => ['sub' => ['arr' => 'value']], 'second' => ['lvl' => ['opt' => 'value']]];
        $this->assertEquals(['first.sub.arr' => ['first', 'first.sub', 'first.sub.arr'], 'second.lvl.opt' => ['second', 'second.lvl', 'second.lvl.opt']], DotArr::keyMatches($array, ['first.sub.arr', 'second.lvl.opt']));
    }
